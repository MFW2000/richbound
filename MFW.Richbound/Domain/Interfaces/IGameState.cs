...
public interface IGameState
{
    ...
    /// <summary>
    /// The player character's current energy points that range from 0 to 100.
    /// </summary>
    int Energy { get; }
    ...
    /// <summary>
    /// Updates the player character's energy points up to a maximum of 100 and a minimum of 0.
    /// </summary>
